					...
					<!-- Brand and toggle get grouped for better mobile display -->
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav cl-effect-8">
								...
								<li><a href="about_s.php">About</a></li>
								<li><a href="student_portfolio.php">Portfolio</a></li>
								<li><a href="student_jobs_index.php">JOB'S</a></li>
								<li><a href="contact_s.php">Contact</a></li>	
							</ul>
						</div><!-- /.navbar-collapse -->
					</div>
					<!-- start search-->
